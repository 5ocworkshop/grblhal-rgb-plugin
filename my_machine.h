...
#define BOARD_MY_MACHINE // Add my_machine_map.h before enabling this!  HAL2000 here for now
...
#define USB_SERIAL_WAIT     1 // ***Wait for USB connection before starting grblHAL. JAC to consider (1 seems to indicate don't wait?)
...
#define RGB_ENABLE            1 // Enable RGB light control for visual indicators using AUX Outputs 0-2.  Default Disabled, uncomment to enable
