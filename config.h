...
*/
#define N_AXIS 3 // Number of axes - not the same as number of motors, ganging Y still supported with N_AXIS 3
#endif
...
#define DEFAULT_LIMITS_TWO_SWITCHES_ON_AXES //  Default disabled. Uncomment to enable. JAC Enabled
...
#define INVERT_CONTROL_PIN_MASK SIGNALS_BITMASK // Default disabled. Uncomment to enable. JAC Enabled
...
#define DEFAULT_HOMING_ENABLE // JAC Enabled so extended homing setup below is accessible
...
#define DEFAULT_HOMING_INIT_LOCK // Default disabled. Uncomment to enable. JAC Enabled
...
#define DEFAULT_HOMING_OVERRIDE_LOCKS // Default disabled. Uncomment to enable. JAC Enabled
...
#define HOMING_SINGLE_AXIS_COMMANDS // Default disabled. Uncomment to enable. JAC Enabled
...
#define HOMING_FORCE_SET_ORIGIN  1 // JAC Disabled to test
